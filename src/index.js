  ...
  update() {
    ...
    for (let i = this.sliceCount - 1; i > 0; i--) {
      ...
      if (i === this.sliceCount - 1) {
        ...
        cheese(ctx, rad, .4, ii, this.sliceSize, this.sliceDegree)
        cheese(ctx, rad, .2, ii, this.sliceSize, this.sliceDegree)
        cheese(ctx, rad, .1, ii, this.sliceSize, this.sliceDegree)
      ...
      ctx.beginPath()
      ctx.arc(x, y, this.sliceDegree / 20, 0, 2 * Math.PI)
